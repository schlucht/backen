...
import (
	...
	"github.com/schlucht/backen/internal/driver"
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "dsn", "schmidschluch6:backen1@tcp(db8.hostpark.net)/schmidschluch6?parseTime=true", "DB connect String")
